...
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ReturnRecord) Validate() error {
	return m.validate(false)
}
...
// nil if none found.
func (m *ReturnRecord) ValidateAll() error {
	return m.validate(true)
}

func (m *ReturnRecord) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// Error returns a concatenation of all the error messages it wraps.
func (m ReturnRecordMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ReturnRecordMultiError) AllErrors() []error { return m }
...
// Field function returns field value.
func (e ReturnRecordValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ReturnRecordValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ReturnRecordValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ReturnRecordValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ReturnRecordValidationError) ErrorName() string { return "ReturnRecordValidationError" }

// Error satisfies the builtin error interface
func (e ReturnRecordValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
