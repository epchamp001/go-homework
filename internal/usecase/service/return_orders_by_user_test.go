...
func TestServiceImpl_ReturnOrdersByClient(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			prepare: func(f *fields, a args) {
				f.tx.WithTxMock.Set(func(_ context.Context, _ pgx.TxIsoLevel, _ pgx.TxAccessMode, _ func(context.Context) error) error {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := service.ReturnOrdersByClient(tt.args.ctx, tt.args.userID, tt.args.ids)
			tt.wantErr(t, err)
